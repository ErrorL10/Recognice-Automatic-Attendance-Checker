...
class add_student(ctk.CTkToplevel):
    def __init__(self, master, **kwargs):
        ...
        self.section_select.grid(row=8,column=0,padx=20,pady=(5, 20), sticky='ew')
        
        #birthday
        self.birthday_label = ctk.CTkLabel(master=self.form_frame, text="Birthday", font=("Roboto", 18))
        self.birthday_label.grid(row=9,column=0,padx=20,pady=(20, 5), sticky='w')
        
        self.birthday_entry = ctk.CTkEntry(master=self.form_frame, placeholder_text="Enter Birthday", font=("Roboto", 18))
        self.birthday_entry.grid(row=10,column=0,padx=20,pady=(5, 20), sticky='ew')
        
        #age
        self.age_label_label = ctk.CTkLabel(master=self.form_frame, text="Age", font=("Roboto", 18))
        self.age_label_label.grid(row=11,column=0,padx=20,pady=(20, 5), sticky='w')
        
        self.age_entry = ctk.CTkEntry(master=self.form_frame, placeholder_text="Enter Age", font=("Roboto", 18))
        self.age_entry.grid(row=12,column=0,padx=20,pady=(5, 20), sticky='ew')
        
        #gender
        self.gender_label = ctk.CTkLabel(master=self.form_frame, text="Gender", font=("Roboto", 18))
        self.gender_label.grid(row=13,column=0,padx=20,pady=(20, 5), sticky='w')
        
        self.gender_select = ctk.CTkComboBox(master=self.form_frame, state='readonly', values=['Male', 'Female'])
        self.gender_select.grid(row=14,column=0,padx=20,pady=(5, 20), sticky='ew')
        
        #contact no
        self.contact_no_label = ctk.CTkLabel(master=self.form_frame, text="Contact No.", font=("Roboto", 18))
        self.contact_no_label.grid(row=15,column=0,padx=20,pady=(20, 5), sticky='w')
        
        self.contact_no_entry = ctk.CTkEntry(master=self.form_frame, placeholder_text="Enter Contact No.", font=("Roboto", 18))
        self.contact_no_entry.grid(row=16,column=0,padx=20,pady=(5, 20), sticky='ew')
        
        #student email
        self.student_email_label = ctk.CTkLabel(master=self.form_frame, text="Student Email", font=("Roboto", 18))
        self.student_email_label.grid(row=17,column=0,padx=20,pady=(20, 5), sticky='w')
        
        self.student_email_entry = ctk.CTkEntry(master=self.form_frame, placeholder_text="Enter Student Email", font=("Roboto", 18))
        self.student_email_entry.grid(row=18,column=0,padx=20,pady=(5, 20), sticky='ew')
        
        #add picture
        self.add_picture_label = ctk.CTkLabel(master=self.form_frame, text="Add Picture", font=("Roboto", 18))
        self.add_picture_label.grid(row=19,column=0,padx=20,pady=(20, 5), sticky='w')
        
        self.add_picture_button = ctk.CTkButton(master=self.form_frame, text="Add Picture", command=self.add_picture)
        self.add_picture_button.grid(row=20,column=0,padx=20,pady=20, sticky='ew')
        
        self.confirm_button = ctk.CTkButton(master=self.form_frame, text="CONFIRM", command=self.add_picture)
        self.confirm_button.grid(row=21,column=0,padx=20,pady=(30, 5), sticky='ew')
        
        self.cancel_button = ctk.CTkButton(master=self.form_frame, text="CANCEL", command=self.add_picture)
        self.cancel_button.grid(row=22,column=0,padx=20,pady=(5, 20), sticky='ew')
